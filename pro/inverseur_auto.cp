#line 1 "E:/Projet 2019/carte fini/INVERSEUR AUTOMATIQUE/pro/inverseur_auto.c"
...
#line 88 "E:/Projet 2019/carte fini/INVERSEUR AUTOMATIQUE/pro/inverseur_auto.c"
}
...
#line 190 "E:/Projet 2019/carte fini/INVERSEUR AUTOMATIQUE/pro/inverseur_auto.c"
...
void main() {
 ...
 while(1){
 SREG_I_bit = 1;
#line 392 "E:/Projet 2019/carte fini/INVERSEUR AUTOMATIQUE/pro/inverseur_auto.c"
 menu();
 if(!SET && !m){
 set_led=5;
 led_timer=0;
 ...
 if(led_timer>=100){
 auto_ = ~auto_;
#line 402 "E:/Projet 2019/carte fini/INVERSEUR AUTOMATIQUE/pro/inverseur_auto.c"
 if(auto_){
 }
